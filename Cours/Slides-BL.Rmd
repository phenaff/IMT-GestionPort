...
1. Contraindre $w_i > 0$ en utilisant le code de la note de cours.
2. Avec la librairie BLCOP, ajouter les "vues" suivantes au modèle. Choisissez les sd qui vous semblent pertinentes.
