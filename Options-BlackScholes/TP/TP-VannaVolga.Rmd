...
volatility curve. Assume $r=0, b=0, T=1$.
...
Using the logic of problem 1 to price a binary call, using the data of TP-Shimko. 

Compare the results with those of Shimko's model.
